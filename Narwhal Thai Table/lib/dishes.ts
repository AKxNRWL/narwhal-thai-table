...
export const DISHES: Dish[] = [
  ...
  { slug: 'thai-fish-cake', name: 'Fish Cakes', thai: 'ทอดมันปลา', category: 'appetizers',
  ...
  { slug: 'crispy-spring-rolls', name: 'Pork Spring Rolls', thai: 'ปอเปี๊ยะหมู', category: 'appetizers',
    description: "Hand-rolled shells that crackle, giving way to a savory heart of ground pork & vegetables.", price: '$11' },
  ...
  { slug: 'nam-sod-crispy-rice', name: 'Nam Sod & Crispy Rice', thai: 'แหนมสดข้าวทอด', category: 'appetizers',
    description: "Ginger-bright, tangy nam sod folded with shards of fried crispy rice — crunchy, sour, gently spicy. Wrapped in cool lettuce.", price: '$17' },
  { slug: 'house-salad', name: 'House Salad', thai: 'สลัดผักสด', category: 'salad',
    description: "Crisp greens, cool cucumber & tomato, chewy-sweet dried cranberries, bright Italian dressing.", price: '$14' },
  ...
  { slug: 'som-tum-lao', name: 'Som Tum Lao', thai: 'ส้มตำลาว', category: 'salad', spicy: true,
    description: "For the bold — fermented fish sauce takes it darker, saltier, unapologetically Isan.", price: '$14' },
  ...
  { slug: 'crying-tiger', name: 'Crying Tiger', thai: 'เสือร้องไห้', category: 'grill', signature: true,
    description: 'Fire-charred rib-eye with a smoky toasted rice–mint–lime sauce & chimichurri — so good the tiger wept.', price: '$20',
    ingredients: [
  ...
  { slug: 'po-tak-seafood', name: 'Po Tak Seafood Soup', thai: 'โป๊ะแตก', category: 'soup', spicy: true,
    description: "'The fish-trap bursts' — a clear, blazing hot & sour broth crowded with seafood & Thai herbs.", price: '$23' },
  { slug: 'wonton-soup', name: 'Wonton Soup', thai: 'เกี๊ยวน้ำ', category: 'soup',
    description: "Silky wontons in a clean chicken broth, bean sprouts & green onion — the gentle one at the table.", price: '$11' },
  ...
  { slug: 'teriyaki-stir-fry', name: 'Teriyaki Stir-Fry', thai: 'ผัดซอสเทอริยากิ', category: 'overrice', protein: true,
    description: "Tender strips glossed in a savory-sweet glaze, over rice.", price: '$11' },
  ...
  { slug: 'thai-boat-noodles', name: 'Thai Boat Noodles', thai: 'ก๋วยเตี๋ยวเรือ', category: 'noodles',
    description: "Slow-simmered beef broth, dark & herbal — tender braised beef, meatballs, Chinese broccoli & sprouts.", price: '$22' },
  ...
  { slug: 'chow-mein', name: 'Chow Mein', thai: 'บะหมี่ผัด', category: 'noodles', protein: true,
    description: "Springy egg noodles tossed with egg, cabbage, celery & carrot.", price: '$14' },
  { slug: 'cabbage-fish-sauce', name: 'Cabbage & Fish Sauce', thai: 'กะหล่ำปลีผัดน้ำปลา', category: 'alacarte', signature: true,
    description: "Deceptively simple, impossible to stop — sweet cabbage flash-seared in premium fish sauce until the edges caramelize.", price: '$15' },
  ...
  { slug: 'white-fish-mango-salad', name: 'White Fish & Mango Salad', thai: 'ปลาทอดยำมะม่วง', category: 'seafood', signature: true,
    description: "Featherweight batter, flaky white fish — a bright, spicy mango salad cuts through every rich bite.", price: '$30' },
