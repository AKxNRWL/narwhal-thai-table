...
LUNCH SPECIALS (weekdays): Monday–Friday 11:30 AM – 3:00 PM, from $11.99 — choose Pad Thai, Pad See Ew, Pad Kee Mao, Krapow, Garlic & Pepper, Cashew, Mixed Vegetables, or a Yellow or Panang curry. Every lunch comes with a fresh salad and a crispy spring roll, plus a cup of soup when dining in. Per-plate lunch prices are confirmed at the counter or by phone — say "from $11.99", never quote a specific lunch price. Details: /lunch. Not offered on weekends.
PARKING: free parking in the plaza lot right in front of the restaurant (Beach Blvd at Garfield Ave), plus free street parking nearby. About 8 minutes from central Fountain Valley and 12 minutes from Westminster straight down Beach Blvd.
DESSERTS: Mango Sticky Rice, Coconut Ice Cream & Bread, and the Narwhal Sundae are on the menu (see prices below). There is NO free ice cream or complimentary dessert — that soft-opening treat ended in early September 2026. Never offer or promise free ice cream; if a guest asks about it, say warmly that it was a soft-opening treat that has ended and suggest the Mango Sticky Rice instead.
