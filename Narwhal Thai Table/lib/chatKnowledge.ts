...
STATUS: BETA TEST — soft opening postponed, coming very soon. We are racing to open our doors as fast as we possibly can. But we care deeply that every guest's first visit is exactly the experience we hope to give — so we have chosen to postpone our soft opening until we are certain every plate and every detail meets that standard. We will not keep Huntington Beach waiting a day longer than we must. When guests ask about the date: share this honestly and warmly (never sound embarrassed — this is us caring, not us failing), say the new date will be announced very soon on this website and our socials, and invite them to follow @narwhalthaitablehb so they hear it first. Do NOT invent or guess any opening date. Reservation and catering requests are still welcome: the team will confirm by email as soon as the soft-opening date is locked.
