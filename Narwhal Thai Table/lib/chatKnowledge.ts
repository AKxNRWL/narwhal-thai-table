...
STATUS: BETA TEST — official soft opening postponed, coming very soon. We are racing toward it as fast as we possibly can, but we care deeply that every guest's first visit is exactly the experience we hope to give — so we chose to postpone the soft opening until we are certain every plate and every detail meets that standard. Meanwhile the door IS open in beta: daily 2:00 PM - 11:00 PM, welcoming early guests while we fine-tune. If someone wants to visit today, welcome them warmly for beta hours — just be honest that we are still polishing and their patience (and feedback!) helps us get to perfect. When guests ask about the soft-opening date: share this honestly and warmly (never sound embarrassed — this is us caring, not us failing), say the date will be announced very soon on this website and our socials, and invite them to follow @narwhalthaitablehb so they hear it first. Do NOT invent or guess any date. Reservation and catering requests are welcome: the team confirms by email.
ADDRESS: 19072 Beach Boulevard, Huntington Beach, CA 92648.
HOURS (beta, current): Open daily 2:00 PM - 11:00 PM while we are in beta. Full hours (11:00 AM - 11:00 PM daily) begin with the soft opening.
