...
/* Client half of /stats. `promoImages` (dish photos that exist on disk) is
   computed by the server page (app/stats/page.tsx) because that check needs
   the filesystem at build time. */
export default function StatsClient({ promoImages }: { promoImages: PromoImageOption[] }) {
      ...
      <div style={{ maxWidth: 1040, margin: '0 auto' }}>
        ...
        {!data ? (
          ...
          <>
            ...
            {/* ── ป้ายโปรโมชั่น (pop-up หน้าเว็บ) — the owner's special, edited here, shown by components/PromoCard.tsx ── */}
            <PromoEditor images={promoImages} />
