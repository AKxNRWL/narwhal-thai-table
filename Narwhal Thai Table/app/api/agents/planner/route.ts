...
const OPEN = new Date('2026-07-16T00:00:00-07:00'); // soft opening target

const SYSTEM = `คุณคือผู้ช่วยวางแผนงานของเจ้าของร้าน Narwhal Thai Table (อาหารไทยตำรับชาววัง, Huntington Beach, รับช่วงร้านเดิม Thai Gulf, ได้กุญแจ ~30 มิ.ย. 2026, soft opening ~16 ก.ค. 2026).
...
export async function GET(req: Request) {
  ...
  const prompt = `วันนี้: ${now.toLocaleDateString('th-TH')} · เหลืออีก ~${days} วันก่อน soft opening (16 ก.ค. 2026).
งานที่ค้างอยู่:
