      ...
      */}
      ...
      <div className="hero-inner">
        <div className="hero-text">
          <span className="label hero-coming-soon">Soft Opening July 20 · Huntington Beach</span>
          <h1 id="hero-title">
            Come sit<br/>with us, <em>neighbor</em>.
          </h1>
          <p>
            A Thai family kitchen on Beach Boulevard — where the recipes we grew up with meet the California coast we now call home. Every plate, by Chef Rainny&apos;s own hands. <strong>Soft opening Monday, July 20</strong> — pull up a chair while we get the kitchen warm.
          </p>
